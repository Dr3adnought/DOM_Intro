...
while (wantsToCreateParagraph) {
  ...
  var newParagraph = document.createElement("p");
  newParagraph.setAttribute("id", "userPara");
  newParagraph.innerHTML = text;
  document.getElementById("paragraph_container").appendChild(newParagraph);
  // var userPara = document.getElementById("userPara")[0];
  newParagraph.style.background = getRandomHexColor();
